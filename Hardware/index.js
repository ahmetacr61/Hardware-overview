...
const cardData = [
    ...
    { title: "GPU", desc: "The GPU, also known as the Graphics Processor Unit, is used to calculate all the things that have something to do with graphics like videogames or 3D Modeling.", img: "gpu.jpg", link: "https://www.youtube.com/watch?v=Kgcfj_KV-mo" },
    { title: "RAM", desc: "The Ram, also known as the Random Access Memory, is the cache which stores Data just the time the PC is running. As soon as you close your Computer the Ram ist set to default back again.", img: "ram.jpg", link: "https://www.youtube.com/watch?v=6pp_krChw_A" },
